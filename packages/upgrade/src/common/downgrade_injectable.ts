 ...
 *
 * {@example upgrade/static/ts/classic/module.ts region="ng2-heroes-service"}
 *
 ...
 *
 * {@example upgrade/static/ts/classic/module.ts region="downgrade-ng2-heroes-service"}
 *
 * Inside an AngularJS component's controller we can get hold of the
 * downgraded service via the name we gave when downgrading.
 *
 * {@example upgrade/static/ts/classic/module.ts region="example-app"}
 *
 * @description
 *
